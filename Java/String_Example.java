...
- Java StringBuffer class is used to create mutable (modifiable) String objects. The StringBuffer class in Java is the same 
...
1) public StringBuilder append(String s):-	It is used to append the specified string with this string. The append() method is
    overloaded like append(char), append(boolean), append(int), append(float), append(double) etc.

2) public StringBuilder insert(int offset, String s):-	It is used to insert the specified string with this string at the
     specified position. The insert() method  is overloaded like insert(int, char), insert(int, boolean), insert(int, int), 
     insert(int, float),       insert(int, double) etc.

3) public StringBuilder replace(int startIndex, int endIndex, String str):-	It is used to replace the string from specified
   startIndex and endIndex.

4) public StringBuilder delete(int startIndex, int endIndex):-	It is used to delete the string from specified startIndex 
   and endIndex.
...
8) public String substring(int beginIndex, int endIndex):-	It is used to return the substring from the specified beginIndex
    and endIndex.
...
Note: The Garbage collector of JVM collects only those objects that are created by new keyword. So if you have created any object 
  without new, you can use  finalize method to perform cleanup processing (destroying remaining objects).

Note: The unused memory is collected in Garbage block , collection of garbage block is called garbage collector and this 
